      ...
      case 'JrdSrv:AudioLoop':
        if(msg.operation === 'start') {
          ...
          if(msg.param === 'mic') {
            ...
            args = ['-tc', '34', '-c', '/etc/ftm_test_config', '-d', '8', '-v', '80'];
          }
          else if(msg.param === 'headset-left') {
            args = ['-tc', '6', '-c', '/etc/ftm_test_config', '-d', '7', '-v',
                 '50', '-file', '/data/mojito_112_signal_30s_9db.wav'];
          }
          else if(msg.param === 'headset-right') {
            args = ['-tc', '7', '-c', '/etc/ftm_test_config', '-d', '7', '-v',
                 '50', '-file', '/data/mojito_112_signal_30s_9db.wav'];
          }
